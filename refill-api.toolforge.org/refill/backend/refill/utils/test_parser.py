    ...
    def test_captioned(self):
        data = [
            (
                ...
                Citation(url="https://example.com", title="caption"),
            ),
            (
                "[http://example.com caption]",
                Citation(url="http://example.com", title="caption"),
            ),
        ...
        data = [
            ...
            (
                ...
                Citation(
                    ...
                    archiveurl="http://archive.tld",
                    archivedate=date(2000, 1, 1),
                ),
            ),
            (
